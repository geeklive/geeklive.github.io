$(document).ready(function(){
    ...
    $('.entry a').each(function(index,element){
        ...
        if(href){
            if(href.indexOf('#') == 0){
            }else if ( href.indexOf('/') == 0 || href.toLowerCase().indexOf('daiweiyang.com')>-1 ){
    ...
    $.getScript('/global/js/prettify/prettify.js',function(){
        prettyPrint();
    });
    ...
    if(/css3-animation/.test(location.href)){
        ...
        $.getScript('/global/js/css3-ani.js',function(){});
    }
});
